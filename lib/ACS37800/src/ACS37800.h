 ...
 * 0.3      30-04-25    Calibrated the voltage divider to 1055.0 from 1000.0 and enabled print debug
*/
...
//Default sense resistance for voltage measurement (Ohms) for 
const float ACS37800_DEFAULT_SENSE_RES = 2700;

//Default voltage-divider resistance for voltage measurement (Ohms)
const float ACS37800_DEFAULT_DIVIDER_RES = 4000000;

//Default current-sensing range
//ACS37800KMACTR-030B3-I2C is a 30.0 Amp part - as per SPX-17873
...
class ACS37800
{
  public:
    ...
    //ACS37800KMACTR-030B3-I2C is a 30.0 Amp part - Default SPX-17873
    //ACS37800KMACTR-090B3-I2C is a 90.0 Amp part
    ...
    //Debugging
    void enableDebugging(); //Turn on debug logging
  ...
  private:
    ...
    //Debug
  	bool _printDebug = false; //Flag to print debugging variables V03 use enableDebugging() to turn on
